...
export class CentreInteretsService {
  ...
  constructor(private httpClient: HttpClient) {
    ...
    this.champ_lexical.set("Sciences","Sciences Humaines et sociales socio anthropo culture");
    this.champ_lexical.set("Humaines","Sciences Humaines et sociales socio anthropo culture");
    this.champ_lexical.set("sociales","Sciences Humaines et sociales socio anthropo culture");
    this.champ_lexical.set("Langues","litterature arts langues traduc interpret culture");
    this.champ_lexical.set("Tourisme","Tourisme et Hôtellerie ");
    this.champ_lexical.set("Hôtellerie","Tourisme et Hôtellerie ");
    this.champ_lexical.set("Commerce","Commerce et vente");
    this.champ_lexical.set("vente","Commerce et vente");
    this.champ_lexical.set("Artisanat","Artisanat arts")
